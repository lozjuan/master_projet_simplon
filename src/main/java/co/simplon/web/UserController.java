...
public class UserController {
    ...
    public ModelAndView addUser(@RequestParam("name") String name, @RequestParam("surname") String surname, String password, String password_control,
        ...
        if (password.equals(password_control)) {
            ...
            User user = new User(name, surname, email, encoder.encode(password), role, 0);
